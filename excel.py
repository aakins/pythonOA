def excel(xlanalysisfile):
    ...
    if analysis.table_exists(table) == True:
        idcolumn = "gs_name"
    ...
    if analysis.table_exists(table) == True:
        ...
        cell += 9
    analysis.collapse_rows(106, 112)
    ...
    if analysis.table_exists(table) == True:
        ...
        cell += 42
    analysis.collapse_rows(115, 154)
    ...
    if analysis.table_exists(table) == True:
        ...
        cell += 6
        analysis.collapse_rows(157, 160)
